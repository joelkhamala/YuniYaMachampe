            ...
            <div class="col-md-9">
                <div class="udb">
                    ...
                    <div class="udb-sec udb-cour">
                        <h4>
                            <img src="images/icon/db2.png" alt="" /> Booking
                            Courses
                        </h4>
                        <p>
                            Many desktop publishing packages and web page
                            editors now use Lorem Ipsum as their default model
                            text.The point of using Lorem Ipsummaking it look
                        ...
                        <div class="sdb-cours">
                            <ul>
                                <li>
                                    <a href="#">
                                        <div
                                            class="list-mig-like-com com-mar-bot-30"
                                        >
                                            <div class="list-mig-lc-img">
                                                ...
                                                />
                                                <span
                                                    class="home-list-pop-rat list-mi-pr"
                                                    >Duration:150 Days</span
                                                >
                                            </div>
                    ...
                    <div class="udb-sec udb-cour-stat">
                        <h4>
                            <img src="images/icon/db3.png" alt="" /> Course
                            Status
                        </h4>
                        <p>
                            Many desktop publishing packages and web page
                            ...
                            <table class="bordered responsive-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>18Aug 2018</td>
                                        <td>
                                            <span class="pro-user-act"
                                                >active</span
                                            >
                                        </td>
                                        <td>
                                            <a
                                                href="sdb-course-edit.html"
                                                class="pro-edit"
                                                >edit</a
                                            >
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="pro-user-act pro-user-de-act"
                                                >de-active</span
                                            >
                                        </td>
                                        <td>
                    ...
                    <div class="udb-sec udb-time">
                        <h4>
                            <img src="images/icon/db4.png" alt="" /> Class Time
                            Line
                        </h4>
                        <p>
                            ...
                            <ul>
                                    ...
                                    <div class="sdb-cl-tim">
                                        ...
                                        <div class="sdb-cl-class">
                                            <ul>
                                                <li>
                                                    <div
                                                        class="sdb-cl-class-tim tooltipped"
                                                        data-position="top"
                                                        data-delay="50"
                                                    ...
                                                    <div
                                                        class="sdb-cl-class-name tooltipped"
                                                        data-position="top"
                                                        data-delay="50"
                                                ...
                                                <li>
                                                    <div
                                                        class="sdb-cl-class-tim"
                                                    >
                                                        <span>11:00 am</span>
                                                        <span>11:45 am</span>
                                                    </div>
                                                    <div
                                                        class="sdb-cl-class-name sdb-cl-class-name-lev"
                                                    >
                                                        <h5>
                                                            Board Exam Training
                                                            Classes
                                ...
                                <li class="l-info-pack-plac">
                                    ...
                                    <p>
                                        ...
                                        Dubai city. Visit Jumeirah Mosque, World
                                        Trade Centre, Palaces and Dubai Museum.
                                        Enjoy your overnight stay at the
                                        hotel.In the evening, enjoy a tasty
                                        dinner on the Dhow cruise. Later, head
                                        back to the hotel for a comfortable
                                        overnight stay.
                                    </p>
                                </li>
                            </ul>
