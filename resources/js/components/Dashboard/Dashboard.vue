    ...
    <div class="col-md-9">
        <div class="udb">
            ...
            <div class="udb-sec udb-cour">
                <h4>
                    <img src="images/icon/db2.png" alt="" /> Booking Courses
                </h4>
                <p>
                    Many desktop publishing packages and web page editors now
                    use Lorem Ipsum as their default model text.The point of
                    using Lorem Ipsummaking it look like readable English.
                </p>
                <div class="sdb-cours">
                    <ul>
                        <li>
                    ...
                    <table class="bordered responsive-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>18Aug 2018</td>
                                <td>
                                    <span class="pro-user-act">active</span>
                                </td>
                                <td>
                                    <a
                            ...
                            <tr>
                                ...
                                <td>21Sep 2018</td>
                                <td>
                                    <span class="pro-user-act pro-user-de-act"
                                        >de-active</span
                                    >
                                </td>
                                <td>
            ...
            <div class="udb-sec udb-time">
                <h4>
                    <img src="images/icon/db4.png" alt="" /> Class Time Line
                </h4>
                <p>
                    ...
                    <ul>
                        ...
                        <li class="l-info-pack-plac">
                            ...
                            <p>
                                ...
                                Visit Jumeirah Mosque, World Trade Centre,
                                Palaces and Dubai Museum. Enjoy your overnight
                                stay at the hotel.In the evening, enjoy a tasty
                                dinner on the Dhow cruise. Later, head back to
